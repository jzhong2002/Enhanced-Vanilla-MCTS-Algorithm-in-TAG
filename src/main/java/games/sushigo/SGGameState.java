...
public class SGGameState extends AbstractGameState {
    ...
    /*
    add determinization, fill in unknown hands
    -> build deck of unseen cards
    -> shuffle with rnd
    -> assign cards to opponent hands consistent with number of cards each should hold
     */

    public void determiniseHiddenInformation(Random rnd, int forplayer) {
